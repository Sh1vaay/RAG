...
* 🏷️ **Metadata Filtering & Query Analysis**: Extracts hard filters (e.g. `publish_year`, `file_type`, `page_number`) using a structured Pydantic Query Analyzer, matching them against automatically enriched metadata during ingestion.
